-- phenotype sepsis_explicit@1.1.0 (grain hadm); compiled by mimicwarehouse.phenotypes.compiler (EP-41)
...
leaf_01_dx AS (
  ...
  WHERE ((d.icd_version = 9 AND (d.icd_code IN ('0031', '0202', '0223', '0362', '0545', '1125', '449', '67022', '67024', '78552', '99591', '99592', '99802') OR d.icd_code LIKE '038%')) OR (d.icd_version = 10 AND (d.icd_code IN ('A021', 'A207', 'A227', 'A267', 'A327', 'A394', 'A427', 'A5486', 'B007', 'B377', 'I76', 'O85') OR d.icd_code LIKE 'A40%' OR d.icd_code LIKE 'A41%' OR d.icd_code LIKE 'R652%' OR d.icd_code LIKE 'T8112%' OR d.icd_code LIKE 'T8144%')))
),
mapped_01_dx AS (
