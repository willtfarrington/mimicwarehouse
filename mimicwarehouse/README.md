...
## Quick start (`mwh` as of EP-41: `doctor` · `paths` · `guard` · `verify` · `schema` · `inventory` · `fixtures` · `canary` · `build` · `jobs` · `catalog` · `sql` · `demo` · `runs` · `tracer` · `units` · `codeset` · `phenotype`; `app` lands in P4)
...
├── tests/                    ✓ pytest; tests/ep/test_epNN.py (+ tests/ep/golden/ compiled-SQL pins, EP-41); tests/fixtures/ (synthetic only); tests/README.md; tests/helpers.py
