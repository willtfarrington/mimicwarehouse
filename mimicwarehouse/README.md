...
## Quick start (`mwh` as of EP-49: `doctor` · `paths` · `guard` · `verify` · `schema` · `inventory` · `fixtures` · `canary` · `build` · `jobs` · `catalog` · `sql` · `demo` · `runs` · `tracer` · `units` · `codeset` · `phenotype` · `disclose` · `qc` · `cohort` · `timeline`; `app` lands in P4)
