...
instead of re-researching. Files land with their owning EP; EP-15 adds its rows when it ships.
...
| reading.md (planned) | Reading list: papers, chapters, methods references | EP-15 |
| datasets.md (planned) | Open companion datasets inventory | EP-15 |
| methods-notes.md (planned) | Methods notes distilled from the reading list | EP-15 |
