...
| [concepts.md](concepts.md) | mimic-code concept inventory (65 `concepts_duckdb` files at the EP-8 pin): execution order, dependencies, per-file sha256, status on DuckDB 1.5.5 (all execute; the failure list is empty) and the deviations table EP-38 fills | EP-37 |
