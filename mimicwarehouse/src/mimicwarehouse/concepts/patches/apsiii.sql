-- mimicwarehouse concept patch: apsiii-equidistant-arms-pr2137 (EP-38; D-19, DESIGN section 8).
...
-- Ported from: https://github.com/MIT-LCP/mimic-code/pull/2137
--   "fix: compare APS III equidistant arms to min not max" (open, unmerged as of 2026-09-06).
-- Change: the "values are equidistant from normal -- pick the larger score" arms for
--   respiratory rate, hematocrit, WBC, sodium, albumin and glucose compared
--   ABS(x_max - mid) with itself (always true); they now compare it with ABS(x_min - mid),
--   as the heart-rate, MBP and temperature arms already did (Knaus et al. 1991,
--   furthest-from-normal selection). Twelve lines change; nothing else.
