-- mimicwarehouse concept patch `sirs-wbc-guard` (EP-38, 2026-09-05).
-- Full replacement of mimic-iv/concepts_duckdb/score/sirs.sql at MIT-LCP/mimic-code commit
...
-- Upstream reference: https://github.com/MIT-LCP/mimic-code/pull/2146
-- Change:
--   the wbc_score missing-data guard also considers wbc_max: a stay whose first-day
--   wbc_min is null but whose wbc_max is present and normal scores 0, not NULL.
